...
# (str) Package name
package.name = celeste

# (str) Package domain (needed for android/ios packaging)
package.domain = linnman.net
...
source.exclude_dirs = .venv, .venv-buildozer, vscode, colab, maths, nautical_almanacs, test, xtras, pics, validation, testing-validation
...
android.manifest.allow_backup = true
...
# android.manifest.application_attrs = android:hardwareAccelerated="true"
