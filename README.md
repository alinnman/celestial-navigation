...
Currently the script suppurts **stationary** observations, i.e. when observations are made from a single position. (I am planning to add an extension for travelling observers.)
