...
*   **Accuracy:** The algorithm does **not** take **refraction** and **geodesy/oblateness** into consideration. For more accuracy you need some more maths, and you will land in non-analytical maths (at least for the geodesy part). Also consider how to relate to true **North**. 
