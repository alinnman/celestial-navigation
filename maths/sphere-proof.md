# Rigorous proof of Earth's sphericity
...
Greek scholars through rigorous observations and conjectures,
and was later passed on to the Romans and Arabs.
In
...
The article can be summarized as experimental findings presented
here as
[**a posteriori**](https://en.wikipedia.org/wiki/A_priori_and_a_posteriori#A_posteriori)
(observational) knowledge.

1. The altitude of any celestial object increases by 1 degree for each 111.1 km
...
**un-biased**, i.e. not yet tied to any interpretation or model fitting. It is just
...
*fit them into a model and/or use a priori reasoning to draw conclusions.*
...
and geometry from antiquity
([Euclid](https://en.wikipedia.org/wiki/Euclid))
to the differential geometry of the 19th century
